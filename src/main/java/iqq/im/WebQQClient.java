...
public class WebQQClient implements QQClient, QQContext {
     ...
     * @param actorDispatcher a {@link QQActorDispatcher} object.
     */
    ...
    public QQActionFuture login(QQStatus status, final QQActionListener listener) {
        ...
        getSession().setState(State.LOGINING);
    ...
    public void beginPollMsg() {
        if (session.getState() == State.OFFLINE) {
        ...
        return procModule.doLogout(new QQActionListener() {
            public void onActionEvent(QQActionEvent event) {
                ...
                if (event.getType() == QQActionEvent.Type.EVT_OK
                    ...
                    session.setState(State.OFFLINE);
                    destroy();
                }
    ...
    public boolean isOnline() {
        return getSession().getState() == State.ONLINE;
    }
    ...
    public boolean isLogining() {
        return getSession().getState() == State.LOGINING;
    }
